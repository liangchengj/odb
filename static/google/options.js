var Zepto = (function () {
  ...
  return (
    ...
    (C.fragment = function (e, r, i) {
      var o, a, c;
      return (
        d.test(e) && (o = n(u.createElement(RegExp.$1))),
        o ||
          (e.replace && (e = e.replace(m, "<$1></$2>")),
    ...
    (C.init = function (e, r) {
      ...
      if ("string" == typeof e)
        if ("<" == (e = e.trim())[0] && p.test(e))
          (i = C.fragment(e, RegExp.$1, r)), (e = null);
        else {
        ...
        if (O(e))
          ...
          (i = C.fragment(e.trim(), RegExp.$1, r)), (e = null);
        else {
          if (r !== t) return n(r).find(e);
          i = C.qsa(u, e);
        }
    ...
    ((n = function (t, e) {
      ...
      return (
        "boolean" == typeof n && ((r = n), (n = i.shift())),
    ...
    (n.fn = {
      ...
      closest: function (t, e) {
        ...
        for (
          ...
          r && !(i ? i.indexOf(r) >= 0 : C.matches(r, t));
      ...
      css: function (t, r) {
        if (arguments.length < 2) {
          var o,
            a = this[0];
          if (!a) return;
          if (((o = getComputedStyle(a, "")), "string" == typeof t))
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            t && !g.test(t.nodeName) && "static" == n(t).css("position");
    ...
    ["after", "prepend", "before", "append"].forEach(function (t, e) {
      ...
      (n.fn[t] = function () {
        var t,
          i,
          o = n.map(arguments, function (e) {
            return "object" == (t = P(e)) || "array" == t || null == e
              ? e
              : C.fragment(e);
          }),
          a = this.length > 1;
      ...
      r.split(/\s/).forEach(function (r) {
        ...
        (a.proxy = function (t) {
          ...
          "addEventListener" in n &&
            n.addEventListener(m(a.e), a.proxy, d(a, u));
      });
    }
        ...
        h(t, e, n, r).forEach(function (e) {
          delete a[o][e.i],
            "removeEventListener" in t &&
              t.removeEventListener(m(e.e), e.proxy, d(e, i));
        });
      });
    }
    ...
    (t.fn.delegate = function (t, e, n) {
      ...
      (t.fn.trigger = function (e, n) {
        return (
          ...
          this.each(function () {
            e.type in u && "function" == typeof this[e.type]
              ? this[e.type]()
    ...
    (f.href = window.location.href),
      ...
      (t.ajax = function (r) {
        ...
        !(function (e) {
          ...
          g.crossDomain ||
            (((o = i.createElement("a")).href = g.url),
            (o.href = o.href),
            (g.crossDomain =
              f.protocol + "//" + f.host != o.protocol + "//" + o.host)),
        ...
        if (
          ...
          return (
            w ||
              (g.url = y(
                g.url,
                g.jsonp ? g.jsonp + "=?" : !1 === g.jsonp ? "" : "callback=?"
              )),
            t.ajaxJSONP(g, x)
          );
        var E,
        ...
        if (
          ...
          (N.onreadystatechange = function () {
            if (4 == N.readyState) {
              ...
              if (
                ...
                (b =
                  b ||
                  ((r = g.mimeType || N.getResponseHeader("content-type")) &&
                    (r = r.split(";", 2)[0]),
                  (r &&
                    (r == u
                      ? "html"
          ...
          return N.abort(), m(null, "abort", N, g, x), N;
        if (g.xhrFields) for (n in g.xhrFields) N[n] = g.xhrFields[n];
        var O = !("async" in g) || g.async;
        for (n in (N.open(g.type, g.url, O, g.username, g.password), j))
          $.apply(N, j[n]);
        return (
          g.timeout > 0 &&
  ...
  $(function () {
    localStorage["auto-homepage"] && "true" == localStorage["auto-homepage"]
      ...
      $(".homepage").each(function () {
        $(this).val() == localStorage.homepage
          ? ($(this).prop("checked", !0), $(this).click())
          : $(this).prop("checked", !1);
      });
